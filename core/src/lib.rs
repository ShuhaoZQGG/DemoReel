...
use types::{EventLog, EventLogRecord, MouseEvent, ZoomKeyframe};
...
mod tests {
    ...
    #[test]
    fn mouse_events_from_log_filters_clicks() {
        let json = r#"{
            "version": 1,
            "recording_id": "test",
            "duration_ms": 3000,
    ...
    fn end_to_end_log_to_keyframes() {
        let json = r#"{
            ...
            "events": [
                ...
                {"type": "click", "x": 500.0, "y": 300.0, "ts": 1200},
                {"type": "move", "x": 600.0, "y": 400.0, "ts": 2000},
                {"type": "click", "x": 800.0, "y": 600.0, "ts": 3000}
            ]
        }"#;
